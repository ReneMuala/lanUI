...
{
    return hlineRGBA(renderer, x1, x2, y, color.r, color.g, color.b, color.a);
}
...
{
    return vlineRGBA(renderer, x, y1, y2, color.r, color.g, color.b, color.a);
}
    /*!
     \brief Draw vertical line with blending.
...
/*!
 ...
 \param color The color value of the rectangle to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int rectangleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 w, Sint16 h, Color color){
    return rectangleRGBA(renderer, x, y, x+w, y+h, color.r, color.g, color.b, color.a);
}
...
//        result |= SDL_SetRenderDrawBlendMode(renderer, (a == 255) ? SDL_BLENDMODE_NONE : SDL_BLENDMODE_BLEND);
    ...
    {
        return roundedRectangleRGBA(renderer, x, y, x+w, y+h, radius, color.r,color.g,color.b,color.a);
    }
...
/*!
 ...
 \param radius The radius of the corner arcs of the box.
 \param color The color value of the box to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int roundedBoxColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 w, Sint16 h, Sint16 radius, Color color){
    return roundedBoxRGBA(renderer, x, y, x+w, y+h, radius, color.r, color.g, color.b, color.a);
}
    /*!
     \brief Draw rounded-corner box (filled rectangle) with blending.
...
int boxColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 w, Sint16 h, Color color){
    return boxRGBA(renderer, x, y, x+w, y+h, color.r,color.g,color.b,color.a);
}
...
/*!
 ...
 \param x2 X coordinate of the second point of the aa-line.
 \param y2 Y coordinate of the second point of the aa-line.
 \param color The color value of the aa-line to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int aalineColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Color color)
{
    return _aalineRGBA(renderer, x1, y1, x2, y2, color.r, color.g, color.b, color.a, 1);
}
    /*!
     \brief Draw anti-aliased line with alpha blending.
...
/*!
 ...
 \param color The color value of the circle to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int circleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Color color)
{
    return ellipseRGBA(renderer, x, y, rad, rad, color.r, color.g, color.b, color.a);
}
...
/*!
 ...
 \returns Returns 0 on success, -1 on failure.
 */
int arcColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Color color)
{
    return arcRGBA(renderer, x, y, rad, start, end, color.r, color.g, color.b, color.a);
}
    /*!
     \brief Arc with blending.
...
/*!
 ...
 \param color The color value of the aa-circle to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int aacircleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Color color)
{
    return aaellipseRGBA(renderer, x, y, rad, rad, color.r,color.g,color.b,color.a);
}
...
/*!
 ...
 \param rx Horizontal radius in pixels of the ellipse.
 \param ry Vertical radius in pixels of the ellipse.
 \param color The color value of the ellipse to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int ellipseColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Color color)
{
    return _ellipseRGBA(renderer, x, y, rx, ry,color.r,color.g,color.b,color.a, 0);
}
    /*!
     \brief Draw ellipse with blending.
...
/*!
 ...
 \param color The color value of the filled circle to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int filledCircleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Color color)
{
    return filledEllipseRGBA(renderer, x, y, rad, rad, color.r,color.g,color.b,color.a);
}
...
/*!
 ...
 \param color The color value of the aa-ellipse to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int aaellipseColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Color color)
{
    return aaellipseRGBA(renderer, x, y, rx, ry, color.r,color.g,color.b,color.a);
}
    /*!
     \brief Draw anti-aliased ellipse with blending.
...
/*!
 ...
 \param color The color value of the filled ellipse to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int filledEllipseColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Color color)
{
    return _ellipseRGBA(renderer, x, y, rx, ry,color.r,color.g,color.b,color.a, 1);
}
...
int pieColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
             Sint16 start, Sint16 end, Color color)
{
    return _pieRGBA(renderer, x, y, rad, start, end, color.r,color.g,color.b,color.a, 0);
}
...
/*!
 ...
 \returns Returns 0 on success, -1 on failure.
 */
int filledPieColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Color color)
{
    return _pieRGBA(renderer, x, y, rad, start, end, color.r,color.g,color.b,color.a, 1);
}
    /*!
     \brief Draw filled pie with alpha blending.
...
/*!
 ...
 \param color The color value of the trigon to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int trigonColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Color color)
{
    return (trigonRGBA(renderer, x1, y1, x2, y2, x3, y3,color.r,color.g,color.b,color.a));
...
/*!
 ...
 \param color The color value of the aa-trigon to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int aatrigonColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Color color)
{
    return (aatrigonRGBA(renderer, x1, y1, x2, y2, x3, y3, color.r,color.g,color.b,color.a));
...
/*!
 ...
 \param color The color value of the filled trigon to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int filledTrigonColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Color color)
{
    return filledTrigonRGBA(renderer, x1, y1, x2, y2, x3, y3, color.r,color.g,color.b,color.a);
...
{
    return polygonRGBA(renderer, vx, vy, n, color.r,color.g,color.b,color.a);
}
...
/*!
 ...
 \param n Number of points in the vertex array. Minimum number is 3.
 \param color The color value of the aa-polygon to draw.
 
 \returns Returns 0 on success, -1 on failure.
 */
int aapolygonColor(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Color color)
{
    return aapolygonRGBA(renderer, vx, vy, n,color.r,color.g,color.b,color.a);
}
...
{
    return bezierRGBA(renderer, vx, vy, n, s, color.r,color.g,color.b,color.a);
}
    /*!
     \brief Draw a bezier curve with alpha blending.
...
{
    return thickLineRGBA(renderer, x1, y1, x2, y2, width, color.r, color.g, color.b, color.a);
}
    /*!
     \brief Draw a thick line with alpha blending.
